...
<head>
    <title>MSBuild Tasks Library</title>
...
<body>
                <h1>MSBuild Tasks Library</h1>
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-Overview"  >
        <h2>Overview</h2>
    <p>
            <img src="images_community/download/attachments/8651508/icon.png" alt="images_community/download/attachments/8651508/icon.png" class="confluence-embedded-image" />
        Allows you to call dynaTrace automation tasks from MSBuild    </p>
    <div class="tablewrap">
        <table>
...
Name    </p>
                ...
                <td rowspan="1" colspan="1">
        <p>
<strong class=" ">MSBuild Tasks Library</strong>    </p>
            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
...
Download    </p>
                ...
                <td rowspan="1" colspan="1">
    <ul class=" "><li class=" ">    <p>
<a href="attachments_174751828_2_dynatrace-msbuild.plugin-6.0.0.6733.zip">MSBuild Tasks for dynaTrace 6.0</a>    </p>
</li><li class=" ">    <p>
<a href="attachments_150700315_1_dynatrace-msbuild.plugin-5.6.0.5713.zip">MSBuild Tasks for dynaTrace 5.6</a>    </p>
</li><li class=" ">    <p>
<a href="attachments_121569599_1_dynatrace-msbuild.plugin-5.5.0.5226.zip">MSBuild Tasks for dynaTrace 5.5</a>    </p>
</li><li class=" ">    <p>
<a href="attachments_100925541_1_dynaTrace_MSBuild_Task_v5.0.zip">MSBuild Tasks for dynaTrace 5</a> (includes a sample build file)    </p>
</li><li class=" ">    <p>
<a href="attachments_89718912_1_dynaTrace_MSBuild_Task_v4.2.zip">MSBuild Tasks for dynaTrace 4.2</a> (includes a sample build file)    </p>
</li><li class=" ">    <p>
<a href="attachments_67829825_1_dynaTrace_MSBuild_Task_v4.1.zip">MSBuild Tasks for dynaTrace 4.1</a> (includes a sample build file)    </p>
</li><li class=" ">    <p>
<a href="attachments_47317049_2_dynaTrace_MSBuild_Task_v3.5.zip">MSBuild Tasks for dynaTrace 3.5</a> (includes a sample build file)    </p>
</li><li class=" ">    <p>
<a href="attachments_17006677_1_dynaTrace_MSBuild_Task_v3.1.zip">MSBuild Tasks for dynaTrace 3.1+</a>    </p>
</li><li class=" ">    <p>
<a href="attachments_8618067_1_dynaTrace_MSBuild_Task_v3.0.zip">MSBuild Tasks for dynaTrace 3.0</a>    </p>
</li></ul>            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
...
Older Versions    </p>
                ...
                <td rowspan="1" colspan="1">
        <p>
<a href="https://community/display/DL/MSBuild+Tasks+Library+for+2.6">MSBuild Tasks Library for 2.6</a>    </p>
            </td>
        </tr>
</tbody>        </table>
            </div>
    </div>
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-Description"  >
        <h2>Description</h2>
    <p>
The Download Package includes an .NET Library that implements several tasks to be used by MSBuild scripts.    </p>
    <p>
...
This library makes use of the <a href="https://community/display/DL/.NET+Command+Library">.NET Command Library</a>.    </p>
    ...
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-Installation"  >
        <h2>Installation</h2>
...
Copy the two extracted dlls to a directory where it can be picked up by MSBuild when executing your build scripts    </p>
</li><li class=" ">    <p>
View the extracted msbuild_sample.xml file. It shows how you can register the new build tasks in your MSBuild scripts    </p>
</li></ol>    </div>
    </div>
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-Usage"  >
        <h2>Usage</h2>
    <p>
You have to register the new Build Tasks with the UseTask configuration entry in your build scripts like this:    </p>
    <div class="confbox programlisting">
                <div class="content">
        <pre><code>&lt;UsingTask AssemblyFile=&quot;dynaTrace.MSBuild.Task.dll&quot; TaskName=&quot;dynaTrace.MSBuild.Task.StartSessionRecordingTask&quot; /&gt;
...
&lt;UsingTask AssemblyFile=&quot;dynaTrace.MSBuild.Task.dll&quot; TaskName=&quot;dynaTrace.MSBuild.Task.SetTestInformation&quot; /&gt;</code></pre>
        </div>
    </div>
    <p>
Each task can now be used in your targets. Following properties are available for the different tasks:    </p>
    <p>
...
CustomProperty: A custom property that should be set for this test information    </p>
    ...
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-Internals"  >
        <h2>Internals</h2>
    <p>
...
The task ConfigureApplicationTask needs write access to the HKLM Registry on your local machine. In case your user does not have the appropriate access rights you will run into errors.    </p>
    ...
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-SampleMSBuildScript"  >
        <h2>Sample MSBuild Script</h2>
    <p>
The download package includes a sample msbuild file. Check it out for a reference    </p>
    <p>
An additional sample can be seen here: <a href="https://community/pages/createpage.action?spaceKey=DL&amp;title=VSTS+Sample+Test+Project&amp;linkCreation=true&amp;fromPageId=8651508">VSTS Sample Test Project</a>    </p>
    </div>
    <div class="section-2"  id="8651508_MSBuildTasksLibrary-Attachments"  >
        <h2>Attachments</h2>
    <p>
    </p>
    <div class="tablewrap">
...
&nbsp;    </p>
                ...
                <td rowspan="1" colspan="1">
        <p>
<a href="MSBuild_Tasks_Library.html">File</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
<a href="MSBuild_Tasks_Library.html">Modified</a>    </p>
            </td>
        </tr>
            ...
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
File                    <a href="https://community/download/attachments/8651508/dynatrace-msbuild.plugin-6.0.0.6733.zip?api=v2">dynatrace-msbuild.plugin-6.0.0.6733&hellip;</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
Jul 16, 2014by<a href="    /community/display/~stefan.frandl@compuware.com ">Stefan Frandl</a>    </p>
            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
</li></ul>    <p>
    </p>
            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynatrace-msbuild.plugin-5.6.0.5713.zip?api=v2">dynatrace-msbuild.plugin-5.6.0.5713&hellip;</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynatrace-msbuild.plugin-5.5.0.5226.zip?api=v2">dynatrace-msbuild.plugin-5.5.0.5226&hellip;</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynaTrace_MSBuild_Task_v5.0.zip?api=v2">dynaTrace_MSBuild_Task_v5.0.zip</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynaTrace_MSBuild_Task_v4.2.zip?api=v2">dynaTrace_MSBuild_Task_v4.2.zip</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynaTrace_MSBuild_Task_v4.1.zip?api=v2">dynaTrace_MSBuild_Task_v4.1.zip</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynaTrace_MSBuild_Task_v3.5.zip?api=v2">dynaTrace_MSBuild_Task_v3.5.zip</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
Mar 23, 2011by<a href="    /community/display/~markus.baumgartner@compuware.com ">Markus Baumgartner</a>    </p>
            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynaTrace_MSBuild_Task_v3.1.zip?api=v2">dynaTrace_MSBuild_Task_v3.1.zip</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
Aug 27, 2009by<a href="    /community/display/~andreas.lehofer@compuware.com ">Andreas Lehofer</a>    </p>
            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
...
<a href="MSBuild_Tasks_Library.html">Edit Labels</a>    </p>
    ...
    <tr>
            <td rowspan="1" colspan="1">
                ...
                <td rowspan="1" colspan="1">
        <p>
ZIP Archive                    <a href="https://community/download/attachments/8651508/dynaTrace_MSBuild_Task_v3.0.zip?api=v2">dynaTrace_MSBuild_Task_v3.0.zip</a>    </p>
            </td>
                <td rowspan="1" colspan="1">
        <p>
Dec 16, 2008by<a href="    /community/display/~andreas.grabner@compuware.com ">Andreas Grabner</a>    </p>
            </td>
        </tr>
    <tr>
            <td rowspan="1" colspan="1">
...
Upload fileFile description<a href="https://community/pages/downloadallattachments.action?pageId=8651508">Download All</a>    </p>
    <p>
    </p>
    </div>
            </div>
